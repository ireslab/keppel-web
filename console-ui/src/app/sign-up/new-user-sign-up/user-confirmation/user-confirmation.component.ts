  ...
  confirmClicked() {
    if (navigator.onLine) {
      var rqst_json = {
        ...
        "premiseType": "",
        "contractDuration": '',//this.DS.usderDetailObj.selectedPlanObj,
        "planType": '',
        "optionalService1": '',//this.DS.usderDetailObj.optionalService1,
        "optionalService2": '',//this.DS.usderDetailObj.optionalService2,
        "optionalService3": '',//this.DS.usderDetailObj.optionalService3,
